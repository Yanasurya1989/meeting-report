        ...
        <form action="{{ route('sma.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-2">
                    @php $peserta = ['Titin Sumiarti', 'Nabilah Salma Putri', 'Moch Maulana Sidik S', 'Susi Rahmawati', 'Jeni Aprilia', 'Asla Zahid Hanifah', 'Teja Zakiah Darojah', 'Wihandani', 'Imas Rini Minarni', 'Berliana Febiola Agustina', 'Ai Sri Winarti, S.Pd.', 'Alda Oktavia, S.Mat.', 'Nova Herdiana', 'Fathimah Az-Zahra', 'Malikussaleh', 'Nur Rohmah, S.Pd', 'Abdurrohman Wahid', 'Dessy Wulandari', 'Nandang', 'Hamdan Alawi', 'Agisna Bilgisthi, S. Pd', 'Ria Rachmawaty', 'Lany Silpi Nopia', 'Mei Ayu Andriani Pgb, S.Hum.']; @endphp
